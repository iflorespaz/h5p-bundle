    ...
    public function contentUserData(Request $request, $contentId, $dataType, $subContentId)
    {
        ...
        if ($data !== NULL && $preload !== NULL && $invalidate !== NULL) {
            ...
            if ($data === '0'){
                 ...
                 */
                $update = $em->getRepository(ContentUserData::class)->findOneBy(
                    [
                ...
                if(!$update){
                     ...
                     * @var $content Content
                     */
                    $content = $em->getRepository(Content::class)->findOneBy(['id' => $contentId]);
            ...
            $data = $em->getRepository(ContentUserData::class)->findOneBy(
                [
                    'subContentId' => $subContentId,
                    'mainContent' => $contentId,
                    'dataId' => $dataType,
